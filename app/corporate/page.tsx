...
import { CorporateDashboard } from "@/app/dashboard/corporate-dashboard"
    ...
    if (selectedRole !== "corporate" && selectedRole !== "admin" && role !== "corporate" && role !== "admin") {
        return (
            <div className="max-w-lg mx-auto mt-20 text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Select the Corporate interface from the selection screen to access this page.</p>
                <button
