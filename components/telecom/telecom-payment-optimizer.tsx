...
import { Sparkles, TrendingUp, Info, CheckCircle2, Zap, Wallet, ShieldCheck, ArrowRightLeft, ShoppingBag } from "lucide-react"
import { Progress } from "@/components/ui/progress"
import { cn } from "@/lib/utils"

interface TelecomPaymentOptimizerProps {
    className?: string
}
...
export function TelecomPaymentOptimizer({ className }: TelecomPaymentOptimizerProps) {
    ...
    const handleOptimize = () => {
        ...
        setTimeout(() => {
            setResult({
                score: 96,
                bestOption: "EcoCash",
                analysis: `For ${product} payments of $${amount}, EcoCash is the neural leader. It offers superior merchant acceptance for ${product.toLowerCase()} in local hubs compared to ${method2}.`,
                comparison: [
                    "Optimal for " + product,
    ...
    // Initial state matching user request defaults
    React.useEffect(() => {
        setAmount("500")
        setMethod1("EcoCash")
        setMethod2("ZIPIT")
    ...
    return (
        <div className={cn("max-w-[1280px] mx-auto pt-0 pb-8 space-y-8 relative", className)}>
            ...
            {/* 1. Top Floating Input Bar */}
            <div className="h-auto md:h-[88px] px-4 py-4 flex flex-col md:flex-row items-center gap-3 group glass-anti-gravity">
                {/* Pill Input: Amount */}
                <div className="flex flex-col flex-1 w-full md:max-w-[130px]">
                ...
                {/* Dropdown: Method 1 */}
                <div className="flex flex-col flex-1 w-full md:max-w-[200px]">
                ...
                <div className="hidden md:block pt-4 text-white/20">
                ...
                <div className="flex flex-col flex-1 w-full md:max-w-[240px]">
            ...
            {/* 2. Main Result Card */}
            {result && (
                <div className="min-h-[260px] p-8 grid grid-cols-1 lg:grid-cols-[260px_1fr_280px] gap-10 group glass-anti-gravity">
                    {/* Left Section: Match Badge + Logo */}
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <p className="text-[15px] text-white/90 leading-relaxed font-medium mb-8">
                            “For Groceries payments of $500, EcoCash is the neural leader. It offers superior merchant acceptance for groceries in local hubs compared to ZIPIT.”
                        </p>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {[
                                "Optimal for Groceries",
                                "High Merchant Acceptance",
                                "Lowest Fee Tier",
                                "Neural Trust High"
                            ].map((item, idx) => (
                    ...
                    {/* Right Section: Efficiency Scorecard */}
            ...
            {/* 3. Additional Info Floating Stats */}
