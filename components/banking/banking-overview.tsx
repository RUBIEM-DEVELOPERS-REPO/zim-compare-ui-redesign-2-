  ...
  return (
    <div className="space-y-4 pb-10">
      ...
      <div className="glass-floating p-4 bg-primary/5 border-primary/20 shadow-xl relative overflow-hidden group teal-glow">
        ...
        <h2 className="text-2xl font-display font-normal text-foreground tracking-tight leading-tight">{bestBank}</h2>
      ...
      {filteredBanks.length === 0 ? (
        ...
        <>
          ...
          {/* Market Highlights */}
          <section>
            <h3 className="text-[10px] font-medium text-foreground uppercase tracking-widest mb-2.5 opacity-70">{t("dashboard.marketHighlights")}</h3>
            <div className="grid gap-2.5 sm:grid-cols-3">
              <div className="glass-floating p-3 h-full floating-hover rounded-xl">
                ...
                <p className="text-sm font-display font-medium text-foreground mt-0.5 leading-tight">Stanbic PureSave</p>
              ...
              <div className="glass-floating p-3 h-full floating-hover rounded-xl">
                ...
                <p className="text-sm font-display font-medium text-foreground mt-0.5 leading-tight">POSB</p>
              ...
              <div className="glass-floating p-3 h-full floating-hover rounded-xl border-primary/20 bg-primary/5">
                ...
                <p className="text-sm font-display font-medium text-foreground mt-0.5 leading-tight">CBZ Home Loan</p>
